...
class SiamFCTracker:
    ...
    def init(self, frame, bbox):
        ...
        exemplar_img = exemplar_img.to(self.device)
        with torch.no_grad():
            exemplar_img_var = Variable(exemplar_img)
            # exemplar_img_var = exemplar_img_var.to(self.device)
    ...
    def update(self, frame):
        ...
        instance_imgs = instance_imgs.to(self.device)
        with torch.no_grad():
            instance_imgs_var = Variable(instance_imgs)
